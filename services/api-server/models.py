...
class CosineSimilarity(torch.nn.Module):
    ...
    def __init__(self, u):
        ...
        self.u = torch.nn.Parameter(torch.tensor(u), requires_grad=False)
        self.sim = torch.nn.CosineSimilarity(self.u.shape[0])

    def forward(self, v):
        return self.sim(self.u, v)
...
class GaussianMixture(torch.nn.Module):
    ...
    def forward(self, x):
        return self.predict(x, probs=False)
