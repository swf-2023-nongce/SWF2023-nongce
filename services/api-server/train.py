...
flags.DEFINE_string('wav_file', None, 'Path to wav file.')
flags.DEFINE_string('output_dir', None, 'Output directory.')
flags.DEFINE_integer('dim', 8, 'Dimension of the feature vector.')
...
def main(_):
    data = utils.read_wav(FLAGS.wav_file)
    feat = utils.get_mfcc_features(data, FLAGS.dim)
    model = models.CosineSimilarity(feat)
